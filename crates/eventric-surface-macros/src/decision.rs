...
impl Decision {
    ...
    fn select(&self) -> TokenStream {
        ...
        quote! {
            impl ::eventric_surface::decision::Select for #ident {
                fn select(
                    &self,
                ...
                > {
                    ::eventric_stream::stream::select::Selections::new([
                        #(::eventric_surface::projection::Select::select(&projections.#proj_field_name)?),*
                    ])
                }
            }
        }
    ...
    fn update(&self) -> TokenStream {
        ...
        quote! {
            impl ::eventric_surface::decision::Update for #ident {
                fn update<C>(
                    &self,
                    codec: &C,
